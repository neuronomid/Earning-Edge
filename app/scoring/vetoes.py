...
def evaluate_hard_vetoes(
    ...
    *,
    ...
    if reality_check is not None:
        ...
        if contract.position_side == "long" and not reality_check.has_named_catalyst_before_exit:
            ...
            if exit_target is not None:
                ...
                if risk_reward is not None and risk_reward < policy.min_long_premium_risk_reward:
                    vetoes.append(
                        HardVeto(
