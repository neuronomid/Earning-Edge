...
def test_main_recommendation_template_matches_prd_structure() -> None:
    recommendation = SimpleNamespace(
        ...
        target_stock_price=Decimal("108.00"),
        target_option_price=Decimal("4.20"),
        stop_loss_option_price=Decimal("0.63"),
        exit_by_date=date(2026, 5, 8),
...
def test_ranked_recommendation_template_uses_bronze_for_third_setup() -> None:
    recommendation = SimpleNamespace(
        ...
        target_stock_price=Decimal("940.00"),
        target_option_price=Decimal("6.80"),
        stop_loss_option_price=Decimal("2.25"),
        exit_by_date=date(2026, 5, 8),
